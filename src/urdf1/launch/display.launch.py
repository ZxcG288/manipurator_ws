...
def generate_launch_description():
    pkgPath = launch_ros.substitutions.FindPackageShare(package='urdf1').find('urdf1') #find package file name
    urdfModelPath = os.path.join(pkgPath, 'urdf/urdf1.urdf') #in package 
