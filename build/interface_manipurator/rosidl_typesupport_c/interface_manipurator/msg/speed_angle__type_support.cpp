...
static const _SpeedAngle_type_support_symbol_names_t _SpeedAngle_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interface_manipurator, msg, SpeedAngle)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interface_manipurator, msg, SpeedAngle)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, interface_manipurator, msg, SpeedAngle)() {
  return &::interface_manipurator::msg::rosidl_typesupport_c::SpeedAngle_message_type_support_handle;
}
