...
bool interface_manipurator__msg__speed_angle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interface_manipurator.msg._speed_angle.SpeedAngle", full_classname_dest, 49) == 0);
  }
  interface_manipurator__msg__SpeedAngle * ros_message = _ros_message;
  {  // speed
...
{
  /* NOTE(esteve): Call constructor of SpeedAngle */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interface_manipurator.msg._speed_angle");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SpeedAngle");
